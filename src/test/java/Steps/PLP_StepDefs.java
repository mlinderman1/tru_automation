...
public class PLP_StepDefs extends AbstractPage_StepDefs {
  ...
  int n;
  ISPU_Flyout__StepDefs ispu = new ISPU_Flyout__StepDefs();
...
//          wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(selector.container__ispu)));
//          wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(selector.btn__ispu__pickup)));
//          wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(selector.btn__ispu__pickup))).click();
//          wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(selector.container__ispu)));
        } catch (Exception e) {
