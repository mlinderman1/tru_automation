package com.toysrus.automation.lib;
...
public class Data {
	...
	public Data(String user__fname, String user__lname, String user__address1,
			String user__address2, String user__city, String user__state,
			String user__zip, String user__phone, String user__email) {
		{
	...
	public static List<String> shop_ByMenu_categoryList()

	{
		List<String> allLinks = new ArrayList<String>();
		allLinks.add("Movie HQ");
		allLinks.add("Top Rated");
		allLinks.add("Boys`Toys");
		allLinks.add("Girls`Toys");
		allLinks.add("Age");
		allLinks.add("Brand");
		allLinks.add("Character");
		allLinks.add("Deals & Savings");
		allLinks.add("Gift Finder");
		allLinks.add("Clearance");
		return allLinks;
	}
